...
insert into girls(name, code, detail, birthday) values('アゲハ', 'ageha', 'テスト用パートナー2', '2021-10-01');
...
insert into user_girls(user_id, girl_id, is_partner) values(1, 1, 1);
insert into user_girls(user_id, girl_id, is_partner) values(1, 2, 0);